...
public class MoviewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        final ProgressBar progressBar     = view.findViewById(R.id.progressMovieList);
        ...
        itemsAdapter.setOnItemClickCallback(new ItemsAdapter.onItemClickCallback() {
            ...
            public void onItemClicked(int id) {
                ...
                intent.putExtra(DetailActivity.ARG_RESOURCES, "movie");
        ...
        if (currentLanguage.equals("en")){
            ...
            mainViewModel.setData("movie","id-ID");
        }
